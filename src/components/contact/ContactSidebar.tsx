...
const ContactSidebar: FC = () => {
	return (
		<div className="lg:w-[200px] lg:min-w-[200px] sm:w-full flex flex-col sm:items-center gap-5 lg:border-r sm:border-b sm:pb-10 border-divider lg:pr-5 sm:flex-row relative">
			<Image
				src={profile}
				alt="Profile photo"
